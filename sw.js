...
const V='j26-v101';const CORE=['./','./index.html','./img/tokyo-hotel.webp','./img/kyoto-apt-1.webp','./img/kyoto-apt-2.webp'];
...
self.addEventListener('fetch',e=>{
  ...
  if(u.hostname==='images.unsplash.com'||u.pathname.startsWith('/img/')||u.pathname.includes('/img/')||u.hostname.includes('fonts.g')||u.hostname==='cdnjs.cloudflare.com'||u.hostname==='upload.wikimedia.org'){
